                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        <div class="article-img">
                            <img src="<?php echo ($data['post']['img_cover'] != null ? URL_IMGADM.$data['post']['img_cover'] : URL_NOIMG)?>" title="" alt="">
                        </div> 
                        <div class="article-title">
                            <h6><a href="#"><?php echo $data['post']['content'] ?></a></h6>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <label><?php echo $data['post']['f_name'].' '.$data['post']['l_name'] ?></label>
                                    <span><?php echo $data['post']['create_at'] ?></span>
                                </div>
                            </div>
                        </div>
                          ...
                          <div>
                            <div class="media g-mb-30 media-comment">
                                ...
                                <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
                                  <div class="g-mb-15">
                                    <h5 class="h5 g-color-gray-dark-v1 mb-0"><?php echo $item['user_name']?></h5>
                                    <span class="g-color-gray-dark-v4 g-font-size-12"><?php echo $item['posted_at']?></span>
                                  </div>
                    ...
                    <div class="contact-form article-comment <?php echo ($data['post']['status_comment'] == 2 ? 'd-none':"")?>">
                        <h4>Leave a comment</h4>
                        <form id="contact-form" action="<?php echo URL_MAIN.'index/blog/'.$data['post']['id'];?>" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input name="username" id="name" placeholder="UserName" class="form-control" type="text">
                                        <small class="text-danger<?php echo (!empty($data['username_err']) ? '':' d-none')?>"><?php echo $data['username_err']?> </small>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea name="comment" id="message" placeholder="Your Comment" rows="4" class="form-control"></textarea>
                                        <small class="text-danger<?php echo (!empty($data['comment_err']) ? '':' d-none')?>"><?php echo $data['comment_err']?> </small>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="send">
                    ...
                    <div class="widget widget-author">
                        ...
                        <div class="widget-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <h6>Hello, I'm<br> <?php echo $data['post']['f_name'].' '.$data['post']['l_name'] ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
